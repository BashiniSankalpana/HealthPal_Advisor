...
test.describe('ResetPassword Page', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto('http://localhost:3000/Reset_Password?token=dfb3e0f414308fdff7185c3ca5f5f3781b6ae0bb'); // Adjust the URL to your actual route
  });
  ...
  test('should display the reset password form and handle user input', async ({ page }) => {
    ...
    await page.fill('input[placeholder="Enter new password"]', 'bashi123456');
    await page.fill('input[placeholder="Confirm new password"]', 'bashi123456');
