...
test('Register with Empty username credentials', async ({ page }) => {
  ...
  // const usernameError = await page.textContent('.error:has-text("Username is required.")');
  // expect(usernameError).toBeTruthy();

  // Check for validation error messages
  // const usernameError = await page.textContent('.error:has-text("Please fill out this field")');
  // expect(usernameError).toBeTruthy();

  //const emailError = await page.textContent('.error:has-text("Please enter a valid email address.")');
  //expect(emailError).toBeTruthy();

  //const passwordError = await page.textContent('.error:has-text("Password must be at least 8 characters long.")');
